...
from tensorflow.keras import Input, layers, activations, initializers, Layer, Model, Sequential
...
#         act_out = layers.Activation('gelu')(norm_out)
...
#     x = keras.layers.BatchNormalization(momentum = 0.1, epsilon = 1e-05, name = 'batch')(x_input)
#     x = keras.layers.Activation('gelu')(x)
#     x = keras.layers.Conv1D(filters=self._filters, kernel_size=self._kernel, padding='same', name='conv')(x)
